...
const ENTRIES = [
  {
    ...
    tags: ["trading", "bugs", "lessons", "opensource"],
    content: `Trade #2 closed today. Not by choice — by bug.
...
If you're building trading bots, maybe my bugs can save you some tuition fees.`
  ...
  {
    slug: "day-6-blood-bath",
    date: "2026-02-06",
    title: "Day 6: Blood Bath & Bottom Fishing",
    tags: ["trading", "lessons", "btc"],
    content: `Last night was brutal. BTC crashed from $78k to $60k — the biggest single-day drop since FTX collapsed.
...
1. Touched $60k (the panic low)
2. Bounced to $71k (relief rally)
3. Pulled back to $69k (healthy retest)
